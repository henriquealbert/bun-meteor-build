...
Package["core-runtime"].queue("minimongo", ["meteor", "diff-sequence", "ecmascript", "ejson", "geojson-utils", "id-map", "mongo-id", "ordered-dict", "random", "tracker", "modules", "ecmascript-runtime", "babel-runtime", "promise", "dynamic-import", "ecmascript-runtime-client"], function () {/* Imports */
...
var ASYNC_COLLECTION_METHODS = ['_createCappedCollection', 'dropCollection', 'dropIndex', 'createIndex', 'findOne', 'insert', 'remove', 'update', 'upsert'];
