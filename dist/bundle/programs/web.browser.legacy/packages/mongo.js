...
Package["core-runtime"].queue("mongo", ["meteor", "allow-deny", "random", "ejson", "minimongo", "ddp", "tracker", "diff-sequence", "mongo-id", "check", "ecmascript", "logging", "ddp-client", "ddp-server", "modules", "ecmascript-runtime", "babel-runtime", "promise", "dynamic-import", "ecmascript-runtime-client"], function () {/* Imports */
...
!function (module1) {
  ...
  Object.assign(Mongo.Collection.prototype, {
    ...
    _insertAsync: function () {
      function _callee9(doc) {
        var options,
          generateId,
          enclosing,
          ...
          function _callee9$(_context9) {
            while (1) switch (_context9.prev = _context9.next) {
              ...
              case 7:
                ...
                break;
              case 9:
                generateId = true; // Don't generate the id if we're the client and the 'outermost' call
                // This optimization saves us passing both the randomSeed and the id
                // Passing both is redundant.
                if (this._isRemoteCollection()) {
                  enclosing = DDP._CurrentMethodInvocation.get();
                  if (!enclosing) {
                    generateId = false;
                  }
                }
              ...
              case 12:
                // On inserts, always return the id that we generated; on all other
                // operations, just return the result from the collection.
                chooseReturnValueFromCollectionResult = function (result) {
                  if (Meteor._isPromise(result)) return result;
                  if (doc._id) {
                    return doc._id;
                  }
                ...
                _context9.next = 16;
                return _regeneratorRuntime.awrap(this._callMutatorMethodAsync('insertAsync', [doc], options));
              case 16:
                result = _context9.sent;
                return _context9.abrupt("return", chooseReturnValueFromCollectionResult(result));
              case 18:
                _context9.prev = 18;
                _context9.next = 21;
              ...
              case 21:
                ...
                return _context9.abrupt("return", chooseReturnValueFromCollectionResult(_result2));
              case 25:
                _context9.prev = 25;
    ...
    updateAsync: function () {
      function _callee10(selector, modifier) {
        var options,
          insertedId,
          args,
          _args10 = arguments;
          ...
          function _callee10$(_context10) {
            while (1) switch (_context10.prev = _context10.next) {
              case 0:
                ...
                options = _objectSpread({}, (_args10.length <= 2 ? undefined : _args10[2]) || null);
              ...
              case 9:
                ...
                args = [selector, modifier, options];
                return _context10.abrupt("return", this._callMutatorMethodAsync('updateAsync', args, options));
              case 13:
                return _context10.abrupt("return", this._collection.updateAsync(selector, modifier, options));
              case 14:
              case "end":
          ...
          function _callee11$(_context11) {
            while (1) switch (_context11.prev = _context11.next) {
              case 0:
                ...
                return _context11.abrupt("return", this._callMutatorMethodAsync('removeAsync', [selector], options));
              case 4:
                return _context11.abrupt("return", this._collection.removeAsync(selector));
              case 5:
              case "end":
    ...
    upsertAsync: function () {
      function _callee12(selector, modifier, options) {
        return _regeneratorRuntime.async(function () {
          function _callee12$(_context12) {
            while (1) switch (_context12.prev = _context12.next) {
              case 0:
                return _context12.abrupt("return", this.updateAsync(selector, modifier, _objectSpread(_objectSpread({}, options), {}, {
                  _returnObject: true,
                  upsert: true
                })));
              case 1:
    ...
    ensureIndexAsync: function () {
      function _callee13(index, options) {
        var self, Log;
        return _regeneratorRuntime.async(function () {
    ...
    createIndexAsync: function () {
      function _callee14(index, options) {
          ...
          function _callee14$(_context14) {
            while (1) switch (_context14.prev = _context14.next) {
              ...
              case 19:
                ...
                throw new Meteor.Error("An error occurred when creating an index for collection \"" + self._name + ": " + _context14.t0.message);
              case 21:
              case "end":
    ...
    createCappedCollectionAsync: function () {
      function _callee17(byteSize, maxDocuments) {
        var self;
        return _regeneratorRuntime.async(function () {
