...
Package["core-runtime"].queue("ddp-client", ["meteor", "check", "random", "ejson", "tracker", "retry", "id-map", "ecmascript", "callback-hook", "ddp-common", "reload", "socket-stream-client", "diff-sequence", "mongo-id", "modules", "ecmascript-runtime", "babel-runtime", "promise", "dynamic-import", "ecmascript-runtime-client"], function () {/* Imports */
...
var Connection = /*#__PURE__*/function () {
  ...
  _proto.callAsync = function () {
    function callAsync(name /* .. [arguments] .. */) {
      ...
      var args,
        ...
        _args2 = arguments;
      return _regeneratorRuntime.async(function () {
        function callAsync$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              args = slice.call(_args2, 1);
              if (!(args.length && typeof args[args.length - 1] === 'function')) {
                _context2.next = 3;
                break;
              }
            ...
            case 3:
              applyOptions = ['returnStubValue', 'returnServerResultPromise', 'returnServerPromise'];
              defaultOptions = {
                returnServerResultPromise: true
              };
              options = _objectSpread(_objectSpread({}, defaultOptions), applyOptions.some(function (o) {
                var _args$;
                return (_args$ = args[0]) === null || _args$ === void 0 ? void 0 : _args$.hasOwnProperty(o);
              }) ? args.shift() : {});
              invocation = DDP._CurrentCallAsyncInvocation.get();
              if (!(invocation !== null && invocation !== void 0 && invocation.hasCallAsyncParent)) {
                _context2.next = 9;
                break;
              }
              return _context2.abrupt("return", this.applyAsync(name, args, _objectSpread(_objectSpread({}, options), {}, {
            ...
            case 9:
              ...
              * */
              ...
              promise = new Promise(function (resolve, reject) {
                ...
                _this2.applyAsync(name, args, _objectSpread({
                  isFromCallAsync: true
                }, options)).then(resolve).catch(reject).finally(function () {
                  DDP._CurrentCallAsyncInvocation._set();
                });
              });
              return _context2.abrupt("return", promise.finally(function () {
                return DDP._CurrentMethodInvocation._setCallAsyncMethodRunning(false);
              }));
            case 13:
            case "end":
  ...
  _proto.applyAsync = function () {
    function applyAsync(name, args, options) {
      var callback,
        ...
        _args3 = arguments;
      return _regeneratorRuntime.async(function () {
        function applyAsync$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              callback = _args3.length > 3 && _args3[3] !== undefined ? _args3[3] : null;
            ...
            case 9:
              stubOptions.stubReturnValue = _context3.sent;
              _context3.next = 15;
              break;
            case 12:
              _context3.prev = 12;
              _context3.t0 = _context3["catch"](6);
              stubOptions.exception = _context3.t0;
            case 15:
              _context3.prev = 15;
            ...
            case 20:
              ...
              stubOptions.exception = _context3.t1;
            case 23:
        ...
        return applyAsync$;
      }(), null, this, [[4, 20], [6, 12, 15, 18]], Promise);
    }
    return applyAsync;
  }();
  _proto._apply = function () {
    function _apply(name, stubCallValue, args, options, callback) {
      ...
      if (future) {
        ...
        return options.returnStubValue ? future.then(function () {
          return stubReturnValue;
        }) : {
  ...
  _proto._performWritesServer = function () {
    function _performWritesServer(updates) {
      var self, _i3, _Object$entries, _ref8, _ref9, storeName, store, _i4, _Object$entries2, _ref10, _ref11, _storeName, updateMessages, _store, _iterator2, _step2, updateMessage, _updates$_storeName, _updates, _i5, _Object$values3, _store2;
      return _regeneratorRuntime.async(function () {
    ...
    function _performWritesClient(updates) {
      ...
      if (self._resetStores || !isEmpty(updates)) {
        ...
        for (var _i6 = 0, _Object$entries3 = Object.entries(self._stores); _i6 < _Object$entries3.length; _i6++) {
          var _ref12 = _Object$entries3[_i6];
          var _ref13 = _slicedToArray(_ref12, 2);
          var storeName = _ref13[0];
          var store = _ref13[1];
        ...
        for (var _i7 = 0, _Object$entries4 = Object.entries(updates); _i7 < _Object$entries4.length; _i7++) {
          var _ref14 = _Object$entries4[_i7];
          var _ref15 = _slicedToArray(_ref14, 2);
          var _storeName2 = _ref15[0];
          var updateMessages = _ref15[1];
          {
  ...
  _proto.onReset = function () {
    function onReset() {
      ...
      Object.entries(this._subscriptions).forEach(function (_ref16) {
