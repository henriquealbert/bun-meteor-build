...
Package["core-runtime"].queue("allow-deny", ["meteor", "ecmascript", "minimongo", "check", "ejson", "ddp", "modules", "ecmascript-runtime", "babel-runtime", "promise", "dynamic-import", "ddp-client", "ddp-server", "ecmascript-runtime-client"], function () {/* Imports */
...
CollectionPrototype._validatedInsertAsync = function (userId, doc, generatedId) {
  ...
  if (self._validators.insertAsync.deny.some(function (validator) {
  ...
  if (self._validators.insertAsync.allow.every(function (validator) {
    return !validator(userId, docToValidate(validator, doc, generatedId));
  })) {
    throw new Meteor.Error(403, "Access denied");
  }
...
CollectionPrototype._validatedUpdateAsync = function () {
  function _callee(userId, selector, mutator, options) {
    ...
    return _regeneratorRuntime.async(function () {
      function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 21:
            if (!self._validators.updateAsync.deny.some(function (validator) {
            ...
            throw new Meteor.Error(403, "Access denied");
          case 23:
            if (!self._validators.updateAsync.allow.every(function (validator) {
              var factoriedDoc = transformDoc(validator, doc);
              return !validator(userId, factoriedDoc, fields, mutator);
            })) {
              _context.next = 25;
          ...
          case 25:
            ...
            return _context.abrupt("return", self._collection.updateAsync.call(self._collection, selector, mutator, options));
          case 27:
          case "end":
...
CollectionPrototype._validatedRemoveAsync = function () {
  function _callee2(userId, selector) {
    ...
    return _regeneratorRuntime.async(function () {
      function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          ...
          case 8:
            if (!self._validators.removeAsync.deny.some(function (validator) {
            ...
            throw new Meteor.Error(403, "Access denied");
          case 10:
            if (!self._validators.removeAsync.allow.every(function (validator) {
              return !validator(userId, transformDoc(validator, doc));
            })) {
              _context2.next = 12;
              break;
            ...
            throw new Meteor.Error(403, "Access denied");
          case 12:
            return _context2.abrupt("return", self._collection.removeAsync.call(self._collection, selector));
          case 13:
          case "end":
...
CollectionPrototype._callMutatorMethodAsync = function () {
  function _callMutatorMethodAsync(name, args) {
    var options,
      ...
      _args3 = arguments;
    return _regeneratorRuntime.async(function () {
      function _callMutatorMethodAsync$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            options = _args3.length > 2 && _args3[2] !== undefined ? _args3[2] : {};
            // For two out of three mutator methods, the first argument is a selector
            firstArgIsSelector = name === "updateAsync" || name === "removeAsync";
            ...
            mutatorMethodName = this._prefix + name;
            return _context3.abrupt("return", this._connection.applyAsync(mutatorMethodName, args, _objectSpread({
